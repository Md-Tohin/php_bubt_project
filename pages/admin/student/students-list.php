...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        ...
                        <div class="view-icons">
                            <a href="?page=students" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                            <a href="?page=students-list" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" id="student-grid-container">
                <div class="col-md-12">
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="profile.html" class="avatar">
                                                        <?php if (isset($row['photo']) && file_exists($row['photo'])) { ?>
                                                            <img alt="" src="<?php echo $row['photo'] ?>">
                                                        <?php } else { ?>
                                                            <img src="assets/img/user.jpg" alt="Image">
                                                        <?php }?>                                                        
                                                    </a>
                                                    <a href="profile.html"><?php echo $row['st_name']?> <span><?php echo $row['st_gender']?></span></a>
                                                </h2>
                                            </td>                                            
                                            <td><?php echo $row['email_id']?></td>
                                            <td><?php echo $row['cell_no']?></td>                                            
                                            <td><?php echo date('j M Y', strtotime($row['st_dob'])) ?></td>
